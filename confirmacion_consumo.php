...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
   ...
   <ul class="nav nav-tabs">
    ...
    <ul class="pager">
    <li class="previous"><a style="background-color: skyblue" class="btn-info" href="info_consumo.php"><span aria-hidden="true">&larr;</span>Atras</a></li>
    <li class="next"><a id="terminar" style="background-color: skyblue" class="btn-info" id="siguiente" href="registro_consumo.php">Terminar<span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
    </div> 
         </div> 
