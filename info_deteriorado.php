...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
   ...
   <ul class="nav nav-tabs">
                ...
                <li role="presentation" class="active"><a href="info_deteriorado.php">Datos</a></li>
                <li role="presentation"><a href="confirmacion_deteriorado.php">Confirmar Envio</a></li>
              </ul>
    ...
    <ul class="pager">
    <li class="previous"><a style="background-color: skyblue" class="btn-info" href="vale_deteriorado.php"><span aria-hidden="true">&larr;</span>Atras</a></li>
    <li class="next"><a style="background-color: skyblue" class="btn-info" id="siguiente" href="confirmacion_deteriorado.php">Siguiente<span aria-hidden="true">&rarr;</span></a></li>
  </ul>
</nav>
    </div> 
         </div> 
