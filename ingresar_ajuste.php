<?php
	...
	include("conectar.php");
		...
		while($rowCa = mysqli_fetch_array($consulta)){
			...
			$sql_update = "UPDATE stock SET existencia = '$rowCa[1]' WHERE id_producto = '$rowProd[0]'";

			$resultUpdate = mysqli_query($link,$sql_update);
		
			$insercion = "INSERT INTO movimiento (tipo,cantidad,fecha,id_producto,id_usuario,id_ecof,numPed) VALUES('Ajuste','$cantidad','$row[1]','$rowProd[0]','$rowUser[0]','$rowEco[0]','$row[3]')";
