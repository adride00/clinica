...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <h3>Reporte Movimientos <small>Medicamentos Vencidos</small></h3>
</div>
    ...
    <div class="row">
      <table class="table table-hover dataTables-example" id="myTable">
                ...
                <?php 
                  ...
                  $sql_select = "SELECT DISTINCT m.numPed, m.fecha, u.nombre, m.tipo FROM movimiento as m JOIN usuario as u ON m.id_usuario = u.id_usuario WHERE m.tipo = 'Vencido' ORDER BY m.id_movimiento DESC"; 
