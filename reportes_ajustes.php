    ...
    <div class="row">
      ...
      <table class="table table-hover dataTables-example" id="myTable">
                ...
                <?php 
                  ...
                  $sql_select = "SELECT DISTINCT m.numPed, m.fecha, u.nombre, m.tipo FROM movimiento as m JOIN usuario as u ON m.id_usuario = u.id_usuario WHERE m.tipo = 'Ajuste' ORDER BY m.id_movimiento DESC"; 
