<?php
	...
	include("conectar.php");
		...
		while($rowCa = mysqli_fetch_array($consulta)){
			...
			$insercion = "INSERT INTO movimiento (tipo,cantidad,fecha,id_producto,id_usuario,id_ecof,numPed) VALUES('Vencido','$cantidad','$row[1]','$rowProd[0]','$rowUser[0]','$rowEco[0]','$row[3]')";
		...
		$resultDelTmp = mysqli_query($link,$sql_DelTmp);
		 ...
		 header("Location:reportes_vencidos.php"); 
